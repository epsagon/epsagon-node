 ...
 */
 ...
 function getAddressInfo(session) {
     ...
     if (connectionHolder && connectionHolder._connectionProvider) {
         ...
         port = connectionProvider._address ===  undefined ? connectionProvider._seedRouter._port : connectionProvider._address.port();
         host = connectionProvider._address === undefined ? connectionProvider._seedRouter._host : connectionProvider._address.host();
     }
 ...
 function getPatchedSubscribeMethods(
     ...
     return {
         ...
         onKeys(_keys) {
             ...
             return observer.onKeys.apply(this, sessionArguments);
         },
         // eslint-disable-next-line require-jsdoc
         onNext(record) {
             records.push(record);
 
             if (observer.onNext) return observer.onNext.apply(this, sessionArguments);
         },
         ...
         onCompleted(summary) {
             ...
             return observer.onCompleted.apply(this, sessionArguments);
         },
         ...
         onError(err) {
             ...
             return observer.onError.apply(this, sessionArguments);
         },
     };
 }
